...
public class MainActivity extends PppVpnActivity {
    ...
    protected VPNLinkConfiguration vpn_load() {
        ...
        vpn.udp.static_.aggligator = 4;
        vpn.udp.static_.servers.add("1.0.0.1:20000");
        vpn.udp.static_.servers.add("1.0.0.2:20000");
        vpn.udp.static_.servers.add("1.0.0.3:20000");
